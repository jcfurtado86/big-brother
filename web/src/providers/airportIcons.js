...
export const AIRPORT_TYPE_META = {
  large_airport:  { size: 34, label: 'Grandes aeroportos',  color: '#C2185B', scale: new NearFarScalar(1e5, 1.2, 2e7, 0.3), maxAlt: AIRPORT_MAX_ALT.large_airport },
  medium_airport: { size: 40, label: 'Médios aeroportos',   color: '#00838F', scale: new NearFarScalar(5e4, 1.0, 5e6, 0.3), maxAlt: AIRPORT_MAX_ALT.medium_airport },
  small_airport:  { size: 38, label: 'Pequenos aeroportos', color: '#9C27B0', scale: new NearFarScalar(1e4, 1.0, 8e5, 0.0), maxAlt: AIRPORT_MAX_ALT.small_airport },
  heliport:       { size: 38, label: 'Helipads',            color: '#8B0000', scale: new NearFarScalar(1e4, 1.0, 8e5, 0.0), maxAlt: AIRPORT_MAX_ALT.heliport },
  seaplane_base:  { size: 19, label: 'Bases hidroavião',    color: '#00CCEE', scale: new NearFarScalar(5e3, 1.0, 6e5, 0.0), maxAlt: AIRPORT_MAX_ALT.seaplane_base },
  balloonport:    { size: 17, label: 'Balões',              color: '#CC88FF', scale: new NearFarScalar(2e3, 1.0, 1e5, 0.0), maxAlt: AIRPORT_MAX_ALT.balloonport },
};
